...
public class Neznayka extends Character {
    ...
    String[] Select_what_say(String... args){
    ...
    public void TooSleep() {
        System.out.println(Select_what_say(
    ...
    public void NameANewAnimal(Animals a) {
        System.out.printf("Оказывается, что %s почувствовал, как его ногу облизывают %s.%n", name, choose_alive(a));
    }
}
